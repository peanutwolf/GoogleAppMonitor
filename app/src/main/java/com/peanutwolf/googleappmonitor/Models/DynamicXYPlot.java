 ...
 */
public class DynamicXYPlot extends XYPlot {

    SimpleDynamicSeries mSeries;

    public DynamicXYPlot(Context context, AttributeSet attributes) {
        super(context, attributes);
    }

    public DynamicXYPlot(Context context, AttributeSet attrs, int defStyle) {
